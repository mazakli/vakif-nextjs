      ...
      <section className="section-pad" style={{ background: 'var(--cream-light)' }}>
        <div className="container" style={{ maxWidth: '780px' }}>
          <div style={{ background: '#fff', borderRadius: '14px', padding: 'clamp(24px,5vw,48px)', boxShadow: '0 4px 24px rgba(1,33,22,.08)' }}>
            <div style={{ height: 280, background: 'linear-gradient(135deg, #012116, #034228)', borderRadius: '10px', marginBottom: '32px', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
              <BlogIcon category={post.category} />
            </div>
            <p style={{ color: '#555', lineHeight: 1.8, fontSize: '1rem', marginBottom: '16px' }}>{post.excerpt}</p>
            <p style={{ color: '#555', lineHeight: 1.8, fontSize: '1rem', marginBottom: '16px' }}>
              Bu haber detayları yakında eklenecektir. Güncellemeler için bizi takip etmeye devam edin.
            </p>
