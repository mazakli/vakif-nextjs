...
export const IconChevronDown  = (p: IconProps) => <S {...p}><polyline points="6 9 12 15 18 9"/></S>;
...
export const IconClothes      = (p: IconProps) => <S {...p}><path d="M20.38 3.46L16 2a4 4 0 01-8 0L3.62 3.46a2 2 0 00-1.34 2.23l.58 3.57a1 1 0 00.99.84H6v10c0 1.1.9 2 2 2h8a2 2 0 002-2V10h2.15a1 1 0 00.99-.84l.58-3.57a2 2 0 00-1.34-2.23z"/></S>;
export const IconVolunteer    = (p: IconProps) => <S {...p}><path d="M20.84 4.61a5.5 5.5 0 00-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 00-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 000-7.78z"/><path d="M12 21.23V12m0 0l-3-3m3 3l3-3"/></S>;
export const IconElderly      = (p: IconProps) => <S {...p}><circle cx="10" cy="5" r="3"/><path d="M6 21v-2c0-2.2 1.8-4 4-4h2"/><path d="M16 10l2 2-2 9"/><line x1="14" y1="17" x2="20" y2="17"/></S>;
export const IconHanger       = (p: IconProps) => <S {...p}><path d="M20.5 17.5a2 2 0 01-2 2h-13a2 2 0 01-2-2l8.5-7 8.5 7z"/><path d="M12 3a2 2 0 012 2c0 1.3-1 2.4-2 3l-8.5 7"/><circle cx="12" cy="3" r="1"/></S>;

/* ── SAYE Logo SVG ── */
export const SayeLogo = ({ size = 48 }: { size?: number }) => (
  <svg width={size} height={size} viewBox="0 0 60 60" fill="none">
    <circle cx="30" cy="30" r="29" fill="#c8a96e" opacity="0.15" stroke="#c8a96e" strokeWidth="1.5"/>
    {/* Heart shape */}
    <path d="M30 42s-14-8-14-18a8 8 0 0114-5.66A8 8 0 0144 24c0 10-14 18-14 18z" fill="#c8a96e" opacity="0.9"/>
    {/* Plant sprouting */}
    <line x1="30" y1="20" x2="30" y2="14" stroke="#012116" strokeWidth="1.8" strokeLinecap="round"/>
    <path d="M30 17c-2-3-5-3-5-3s0 3 2 4" stroke="#012116" strokeWidth="1.5" strokeLinecap="round" fill="none"/>
    <path d="M30 16c2-3 5-3 5-3s0 3-2 4" stroke="#012116" strokeWidth="1.5" strokeLinecap="round" fill="none"/>
  </svg>
);
...
export const IconOrphan = ({ size = 48, color = 'currentColor' }: IconProps) => (
  <svg width={size} height={size} viewBox="0 0 64 64" fill="none" stroke={color} strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round">
    ...
    <path d="M6 56c0-8.84 7.16-16 16-16"/>
    <circle cx="44" cy="20" r="7"/>
    <path d="M36 56c0-7.73 6.27-14 14-14"/>
    <path d="M28 56c0-6 3-11 8-14"/>
  </svg>
);

/* ── Hizmet alanı ikonları — SAYE tarzı ince çizgi ── */
export const IconServiceFood = ({ size = 44, color = 'currentColor' }: IconProps) => (
  <svg width={size} height={size} viewBox="0 0 48 48" fill="none" stroke={color} strokeWidth="1.7" strokeLinecap="round" strokeLinejoin="round">
    <rect x="8" y="18" width="32" height="22" rx="3"/>
    <path d="M8 18l3-10h26l3 10"/>
...
export const IconServiceClothes = ({ size = 44, color = 'currentColor' }: IconProps) => (
  <svg width={size} height={size} viewBox="0 0 48 48" fill="none" stroke={color} strokeWidth="1.7" strokeLinecap="round" strokeLinejoin="round">
    <path d="M16 4a4 4 0 008 0"/>
    <path d="M16 4L8 10l4 6 4-3v27h16V13l4 3 4-6-8-6"/>
  </svg>
);

export const IconServiceEducation = ({ size = 44, color = 'currentColor' }: IconProps) => (
  <svg width={size} height={size} viewBox="0 0 48 48" fill="none" stroke={color} strokeWidth="1.7" strokeLinecap="round" strokeLinejoin="round">
    <path d="M4 17l20-9 20 9-20 9L4 17z"/>
    <path d="M12 21v10c0 4 6 8 12 8s12-4 12-8V21"/>
    <line x1="44" y1="17" x2="44" y2="30"/>
    <circle cx="44" cy="32" r="1.5" fill={color} stroke="none"/>
  </svg>
);

export const IconServiceOrphan = ({ size = 44, color = 'currentColor' }: IconProps) => (
  <svg width={size} height={size} viewBox="0 0 48 48" fill="none" stroke={color} strokeWidth="1.7" strokeLinecap="round" strokeLinejoin="round">
    <circle cx="16" cy="14" r="6"/>
    <path d="M4 42c0-6.63 5.37-12 12-12"/>
    <circle cx="32" cy="15" r="5"/>
    <path d="M28 42c0-5.52 4.48-10 10-10"/>
    <path d="M20 42c0-4 2-8 6-10"/>
  </svg>
);

export const IconServiceElderly = ({ size = 44, color = 'currentColor' }: IconProps) => (
  <svg width={size} height={size} viewBox="0 0 48 48" fill="none" stroke={color} strokeWidth="1.7" strokeLinecap="round" strokeLinejoin="round">
    <circle cx="16" cy="12" r="5"/>
    <path d="M8 42v-14c0-3.3 2.7-6 6-6h4c2 0 3.8.9 5 2.4"/>
    <line x1="8" y1="31" x2="16" y2="31"/>
    <circle cx="34" cy="12" r="5"/>
    <path d="M26 42v-14c0-3.3 2.7-6 6-6h4c3.3 0 6 2.7 6 6v14"/>
    <line x1="26" y1="31" x2="34" y2="31"/>
  </svg>
);

export const IconServiceEmergency = ({ size = 44, color = 'currentColor' }: IconProps) => (
  <svg width={size} height={size} viewBox="0 0 48 48" fill="none" stroke={color} strokeWidth="1.7" strokeLinecap="round" strokeLinejoin="round">
    <path d="M34 8a12 12 0 010 16.97L24 34.97 14 24.97A12 12 0 1134 8z"/>
    <path d="M8 38c4-2 10-2 14 0s10 2 14 0"/>
